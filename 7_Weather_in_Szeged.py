...
parser.add_argument('-data_file_path', type=str, default='/Users/zafarzhonirismetov/Desktop/weatherHistory.csv')
...
data_raw = pd.read_csv(args.data_file_path)
...
class DatasetLoadWeather(torch.utils.data.Dataset):
...
# file_utils.FileUtils.createDir(path_artificats)
