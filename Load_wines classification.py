...
#     def __init__(self):
#         self.layers = [
#             LayerLinear(in_features=13, out_features=26), # W_1*x + b < dW , db
#             LayerReLU(),
#             LayerLinear(in_features=26, out_features=7), # W_2*x + b
#             LayerReLU(),
#             LayerLinear(in_features=7, out_features=3), # W_3*x + b
#             LayerSoftmax()
#         ]
#
#     def forward(self, x):
...
#             torch.nn.Linear(13,26),
#             torch.nn.ReLU(),
#             torch.nn.Linear(26,7),
#             torch.nn.ReLU(),
#             torch.nn.Linear(7,3),
#             torch.nn.Softmax()
#         )
